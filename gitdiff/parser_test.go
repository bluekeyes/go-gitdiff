	...
	textFragments := []*TextFragment{
		{
			...
			Lines: []Line{
				...
				{Op: OpDelete, Line: "old line 1\n", OldLineNo: 4, NewLineNo: 0},
				{Op: OpDelete, Line: "old line 2\n", OldLineNo: 5, NewLineNo: 0},
				{Op: OpContext, Line: "context line\n", OldLineNo: 6, NewLineNo: 4},
				{Op: OpAdd, Line: "new line 1\n", OldLineNo: 0, NewLineNo: 5},
				{Op: OpAdd, Line: "new line 2\n", OldLineNo: 0, NewLineNo: 6},
				{Op: OpAdd, Line: "new line 3\n", OldLineNo: 0, NewLineNo: 7},
				{Op: OpContext, Line: "context line\n", OldLineNo: 7, NewLineNo: 8},
				{Op: OpDelete, Line: "old line 3\n", OldLineNo: 8, NewLineNo: 0},
				{Op: OpAdd, Line: "new line 4\n", OldLineNo: 0, NewLineNo: 9},
				{Op: OpAdd, Line: "new line 5\n", OldLineNo: 0, NewLineNo: 10},
			},
			LinesAdded:     5,
			LinesDeleted:   3,
			LeadingContext: 1,
		},
		{
			...
			Comment:     "fragment 2",
			Lines: []Line{
				{Op: OpContext, Line: "context line\n", OldLineNo: 31, NewLineNo: 33},
				{Op: OpDelete, Line: "old line 4\n", OldLineNo: 32, NewLineNo: 0},
				{Op: OpAdd, Line: "new line 6\n", OldLineNo: 0, NewLineNo: 34},
			},
			LinesAdded:     1,
			LinesDeleted:   1,
			LeadingContext: 1,
